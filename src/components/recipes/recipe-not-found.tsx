...
export function RecipeNotFound() {
  return (
    <div className="mx-auto flex min-h-[calc(100vh-8rem)] w-full max-w-3xl items-center px-4 py-10 sm:px-6 lg:px-8">
      <div className="w-full rounded-2xl border bg-card p-8 text-center shadow-subtle">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gravy-gold/10 text-gravy-brown">
          <SearchX className="h-7 w-7" aria-hidden="true" />
        </div>
        <Badge className="mt-5" variant="neutral">
          Not found
        </Badge>
        <h1 className="mt-4 text-2xl font-semibold text-gravy-charcoal">Recipe not found</h1>
